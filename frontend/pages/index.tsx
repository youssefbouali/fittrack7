      ...
      <div className="landing-container">
        <div className="landing-header">
          <div className="landing-logo">
            ...
            <h1 className="landing-logo-text">FitTrack</h1>
          </div>
          <p className="landing-tagline">Track workouts, meals and progress.</p>
        </div>

        <div className="landing-hero">
          <h2 className="landing-hero-title">Your Fitness Journey Starts Here</h2>
          ...
          <div className="landing-features">
            <div className="feature-item">
              ...
              <p className="feature-description">Log your workouts with detailed metrics</p>
            </div>
            ...
            <div className="feature-item">
              ...
              <h3 className="feature-title">Monitor Progress</h3>
              <p className="feature-description">View your stats and achievements</p>
            </div>
            ...
            <div className="feature-item">
              ...
              <p className="feature-description">Build healthy habits over time</p>
            </div>
          </div>

          <div className="landing-cta">
            {isAuthenticated && user ? (
              <Link className="cta-button primary" href="/dashboard">
                Open Dashboard
              </Link>
            ) : (
              <>
                <Link className="cta-button primary" href="/login">
                  Login
                </Link>
                <Link className="cta-button secondary" href="/register">
                  Sign Up
                </Link>
              </>
            )}
